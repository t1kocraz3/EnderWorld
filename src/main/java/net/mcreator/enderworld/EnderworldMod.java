package net.mcreator.enderworld;
...
import net.mcreator.enderworld.init.EnderworldModTabs;
import net.mcreator.enderworld.init.EnderworldModMenus;
import net.mcreator.enderworld.init.EnderworldModItems;
...
@Mod("enderworld")
public class EnderworldMod {
	public static final Logger LOGGER = LogManager.getLogger(EnderworldMod.class);
	public static final String MODID = "enderworld";

	public EnderworldMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		EnderworldModBlocks.REGISTRY.register(modEventBus);
		EnderworldModBlockEntities.REGISTRY.register(modEventBus);
		EnderworldModItems.REGISTRY.register(modEventBus);
		EnderworldModTabs.REGISTRY.register(modEventBus);
		EnderworldModMenus.REGISTRY.register(modEventBus);
